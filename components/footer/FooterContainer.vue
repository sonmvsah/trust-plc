  ...
  <div>
    ...
    <section class="bg-white pt-7 pb-14">
      <div class="container px-8 mx-auto sm:px-12 lg:px-20">
        ...
        <div
          class="flex grid items-center justify-center grid-cols-12 md:grid-cols-12 gap-y-8"
        >
          <div
    ...
    <section class="text-gray-700 bg-white body-font">
      ...
      >
        <a
          ...
          >Sự Thật Pháp Luân Công<span class="text-indigo-600">.</span></a
        >
        <p
          class="mt-4 text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l sm:border-gray-200 sm:mt-0"
        >
          © 2022 Pháp Luân Blog - Pháp Luân Công và Sự thật
        </p>
        <span
