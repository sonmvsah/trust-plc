<template>
  <div class="">
    <!-- Section 1 -->
    <section class="relative w-full bg-white px-5 mt-0 md:mt-0 md:px-32 z-0">
      <!-- <div class="w-full h-32 bg-gradient-to-b from-gray-100 to-white"></div> -->
      <Mvs-tada>
        <div
          class="relative w-full px-5 py-10 mx-auto sm:py-12 md:py-16 md:px-10 max-w-7xl bg-gradient-to-b from-gray-100 to-white rounded-xl mt-10"
        >
          <h1
            class="mb-1 text-4xl font-extrabold leading-none text-gray-900 lg:text-5xl xl:text-6xl sm:mb-3"
          >
            <a href="#_">Pháp Luân Công là gì | Bản chất sự việc</a>
          </h1>
          <p class="text-lg font-medium text-gray-500 sm:text-2xl">
            Pháp Luân Công trước khi được biết đến tại Việt Nam vào những năm
            2000 thì trước đó đã có một quá trình phát triển nở rộ tại Trung
            Quốc, với hơn 100 triệu người đọc sách (học Pháp) và luyện công hằng
            ngày.
          </p>
          <div
            class="flex grid h-full grid-cols-12 gap-x-[1rem] gap-y-[2rem] md:gap-10 pb-10 mt-8 sm:mt-16"
          >
            <div
            ...
            >
              <a
                ...
                style="
                  background-image: url('https://cdn.devdojo.com/images/may2021/quench-satisfying.jpg');
                "
              >
              </a>
              <div
            ...
            >
              <a
                ...
                class="block w-full transition duration-300 ease-in-out transform bg-center bg-cover h-96 hover:scale-110"
                style="
                  background-image: url('https://cdn.devdojo.com/images/may2021/orange.jpg');
                "
              >
              </a>
              <div
            ...
            >
              <a
                ...
                class="block w-full transition duration-300 ease-in-out transform bg-center bg-cover h-96 hover:scale-110"
                style="
                  background-image: url('https://cdn.devdojo.com/images/may2021/gbc.jpg');
                "
              ></a>
              <div
              ...
              >
                ...
                >
                  ...
                  <h2 class="text-base font-bold sm:text-lg md:text-xl">
                    <a href="#_">Best Workstations of the Year</a>
                  </h2>
    ...
    <p
      class="text-justify mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-full px-8 px-5 mt-10 md:px-32"
    >
      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Error assumenda
      a vero dolores, reiciendis maxime aliquid voluptas saepe recusandae,
      placeat dolorem libero labore distinctio sequi, cupiditate quae natus
      nobis adipisci? dolor sit amet consectetur adipisicing elit. Error
      assumenda a vero dolores, reiciendis maxime aliquid voluptas saepe
      recusandae,
      <NuxtLink class="text-purple-600" to="/">placeat dolorem</NuxtLink>
      placeat dolorem libero labore distinctio sequi, cupiditate quae natus
      nobis adipisci?
    </p>
  </div>
